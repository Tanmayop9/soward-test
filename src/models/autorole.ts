import type { Database, AutoroleData } from '../types/index';
...
class AutoroleModel {
    ...
    async getSettingsar(guild: Guild): Promise<AutoroleData & { save: () => Promise<any> }> {
...
const getSettingsar = async (guild: Guild): Promise<AutoroleData & { save: () => Promise<any> }> => {
